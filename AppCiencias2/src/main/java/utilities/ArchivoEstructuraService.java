    ...
    if (!contenido.isEmpty()) {
        ...
        for (String v : vertices) {
            ...
            // =========================
                ...
                datos.setVertices1(
                        linea.substring("VERTICES1=".length()).trim()
                );
                ...
                datos.setAristas1(
                        linea.substring("ARISTAS1=".length()).trim()
                );
                ...
                datos.setVertices2(
                        linea.substring("VERTICES2=".length()).trim()
                );
                ...
                datos.setAristas2(
                        linea.substring("ARISTAS2=".length()).trim()
                );
